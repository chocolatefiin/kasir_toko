        ...
        <div class="card-header">
            <div class="row">
                <div class="col">
                    ...
                    <p>Nama Pelanggan : {{ $penjualan->pelanggan ? $pelanggan->pelanggan->name : '-' }}</p>
                    <p>No. Telepon : {{ $penjualan->pelanggan ? $pelanggan->pelanggan->nomor_tlp : '-' }}</p>
                    <p>Alamat : {{ $penjualan->pelanggan ? $pelanggan->pelanggan->alamat : '-' }}</p>
                </div>
                <div class="col">
